...
Book Room:
Lets users book an available room by entering guest details. Once booked, the room status updates automatically, simulating a real-world hotel reservation process.
Exit:
Safely closes the program, ensuring a clean and smooth end to the session.
